...
public:
    ...
    void setupUi(QMainWindow *LoginWindow)
    {
        ...
        LoginWindow->setMaximumSize(QSize(400, 700));
...
"			"));
        ...
        loginCard->setMinimumSize(QSize(380, 600));
        loginCard->setMaximumSize(QSize(400, 900));
        ...
        loginTabs->setMinimumSize(QSize(0, 500));
        loginTabs->setMaximumSize(QSize(16777215, 550));
        loginTab = new QWidget();
        loginTab->setObjectName("loginTab");
        loginTab->setMinimumSize(QSize(0, 500));
        loginTab->setMaximumSize(QSize(16777215, 500));
        verticalLayout_3 = new QVBoxLayout(loginTab);
        verticalLayout_3->setObjectName("verticalLayout_3");
        verticalLayout_6 = new QVBoxLayout();
        verticalLayout_6->setObjectName("verticalLayout_6");
        verticalLayout_6->setContentsMargins(-1, -1, -1, 22);
        ...
        verticalLayout_6->addWidget(loginButton, 0, Qt::AlignmentFlag::AlignVCenter);
        ...
        signupTab->setMinimumSize(QSize(0, 650));
        signupTab->setMaximumSize(QSize(16777215, 650));
        ...
        verticalLayout_5->setContentsMargins(-1, 0, -1, 5);
