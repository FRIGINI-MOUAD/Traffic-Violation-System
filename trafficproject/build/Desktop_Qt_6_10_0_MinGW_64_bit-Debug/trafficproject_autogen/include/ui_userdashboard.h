...
public:
    ...
    void setupUi(QWidget *UserDashboard)
    {
        ...
        UserDashboard->resize(1064, 700);
        UserDashboard->setMinimumSize(QSize(1064, 700));
        UserDashboard->setMaximumSize(QSize(1064, 700));
...
"   "));
        ...
        Titlelabel = new QLabel(UserDashboard);
        ...
        frame_3->setMinimumSize(QSize(0, 120));
        ...
        payButton->setMinimumSize(QSize(200, 60));
        ...
        searchEdit->setMinimumSize(QSize(500, 50));
        ...
        verticalLayout->addWidget(frame_3, 0, Qt::AlignmentFlag::AlignVCenter);

        frame = new QFrame(UserDashboard);
        frame->setObjectName("frame");
        frame->setMinimumSize(QSize(0, 190));
        frame->setMaximumSize(QSize(16777215, 190));
        ...
        totalBox->setMinimumSize(QSize(300, 150));
        totalBox->setMaximumSize(QSize(300, 90));
        vboxLayout = new QVBoxLayout(totalBox);
        vboxLayout->setObjectName("vboxLayout");
        totalLabel = new QLabel(totalBox);
        totalLabel->setObjectName("totalLabel");
        totalLabel->setMinimumSize(QSize(250, 100));
        ...
        pendingBox->setMinimumSize(QSize(300, 150));
        pendingBox->setMaximumSize(QSize(300, 90));
        vboxLayout1 = new QVBoxLayout(pendingBox);
        vboxLayout1->setObjectName("vboxLayout1");
        pendingLabel = new QLabel(pendingBox);
        pendingLabel->setObjectName("pendingLabel");
        pendingLabel->setMinimumSize(QSize(250, 100));
        ...
        violationsTableBox->setMinimumSize(QSize(0, 263));
        violationsTableBox->setMaximumSize(QSize(16777215, 263));
        vboxLayout2 = new QVBoxLayout(violationsTableBox);
        vboxLayout2->setObjectName("vboxLayout2");
        tableView = new QTableView(violationsTableBox);
        tableView->setObjectName("tableView");
        tableView->setMinimumSize(QSize(0, 218));
        tableView->setMaximumSize(QSize(16777215, 218));
    ...
    void retranslateUi(QWidget *UserDashboard)
    {
        ...
        Titlelabel->setText(QCoreApplication::translate("UserDashboard", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; font-weight:700;\">User Dashboard</span></p></body></html>", nullptr));
